...
% 读取图像 大小为 5*5 的方块
file = ['D:\Matlab\TestSet-STMD\TestSet-For-Selection-of-LoG-and-DoG-Filter-Parameters\','Size-12-12.jpg'];
...
Parameters = zeros(7,1);
Parameters(1) = 100;                % Kernel Size
Parameters(2) = 3.7;                % Sigma_1 = 1.5  对于大小为 5*5 的最佳 Sigma   （1.5,3.0）
Parameters(3) = 2*Parameters(2);    % Sigma_2 = 2*Sigma_1 为对 LoG (Normalized) 的最佳近似(Best approximation)
Parameters(4) = 1;                  % e
Parameters(5) = 0;                  % rho
Parameters(6) = 1;                  % A 
