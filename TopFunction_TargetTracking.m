...
if ~exist('Max_Operation_DS_STMD_Outputs','var')
    if ~exist(strcat(Parameter_File.folder_Global,'\','Max_Operation_DS_STMD_Outputs.mat'),'file')
        Max_Operation_On_DS_STMD_Outputs
    else
        load(strcat(Parameter_File.folder_Global,'\','Max_Operation_DS_STMD_Outputs.mat'))
    end
end
