...
Parameter_File.BackgroundVelocity = BackgroundVelocity_Range(i_Background_Velocity);
Parameter_File.MotionMode = 'SameDirection';                 % OppositeDirection, SameDirection, NoRelativeMotion, BackgroundStationary
...
Parameter_File.folder_Global = ['Data-Journal-Paper-1\Data-for-DR-FA\Varying-Background-Velocity\',Parameter_File.BackgroundType,'\',Parameter_File.MotionMode,'\Background-Velocity\','Background-Velocity-',num2str(Parameter_File.BackgroundVelocity)];
