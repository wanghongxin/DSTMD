...
%     
    ...
    if Parameter_Fun.IsRecordData == 1  && (i >= Parameter_File.StartRecordFrame)
        ...
        if i == Parameter_File.StartRecordFrame
            RecordedData_ESTMD = cell(Parameter_File.EndFrame-Parameter_File.StartRecordFrame+1,1);
        end
        
        % 调用 DataRecording.m 记录数据
        [ RecordedData_ESTMD ] = DataRecording_ESTMD(Photoreceptors_Outptut,LMCs_High_Pass_Output,...
                              ...
                              Parameter_File.StartRecordFrame,i,RecordedData_ESTMD);
    ...
    if Parameter_Fun.IsSaveData == 1
        ...
        if i == Parameter_File.EndFrame
            ...
            save(file,'RecordedData_ESTMD','StartFrame','EndFrame','StartRecordFrame','-v7.3')
        end
    end
