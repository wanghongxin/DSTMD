function [DS_STMD_Inhibition_Kernel] = Generalize_DS_STMD_Inhibition_Kernel(Parameter_Vector)

% 函数说明
% 该函数用于生成 DS-STMD Lateral Inhibition Kernel, DoG 形式
...
DS_STMD_Inhibition_Kernel = A*Positive_Component - B*Negative_Component;
